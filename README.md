...
Protótipo de monitoramento ambiental para estufas de cultivo de champignon de Paris (Agaricus bisporus), utilizando sensores de umidade do solo/substrato e umidade do ar conectados a um Arduino, com registro contínuo dos dados em banco de dados.
